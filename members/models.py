...
class Member(AbstractUser):  # members inheriting from AbstractUser model
    ...
    picture = models.ImageField(upload_to='static/uploads', height_field=None, width_field=None,
                                max_length=None, null=True, blank=True, default='static/images/no_image.jpeg')
